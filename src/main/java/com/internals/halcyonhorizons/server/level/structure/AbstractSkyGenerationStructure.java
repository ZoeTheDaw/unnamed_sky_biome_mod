...
public abstract class AbstractSkyGenerationStructure extends Structure {
    private final ResourceKey<Biome> matchingBiome;

    protected AbstractSkyGenerationStructure(StructureSettings settings, ResourceKey<Biome> matchingBiome) {
        super(settings);
